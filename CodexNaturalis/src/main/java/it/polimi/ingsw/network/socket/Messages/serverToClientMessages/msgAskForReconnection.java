 ...
 */
public class msgAskForReconnection extends ServerGenericMessage {
     ...
     */
    public msgAskForReconnection(Player triedToJoin, GameImmutable model) {
    ...
    public void execute(GameListenerInterface lis) throws RemoteException {
        lis.AskForReconnection(triedToJoin, model);
    }
}
